...
tape('Salat data manipulator', (assert) => {
  ...
  const salatArrayToday = salatManipulator.transformSalatList(salatListToday);
  const nextSalat = salatManipulator.getNextSalat(salatListToday, salatListTomorrow);
